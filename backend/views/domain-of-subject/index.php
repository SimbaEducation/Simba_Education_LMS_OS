...
/* @var $searchModel backend\models\DomainOfSubjectSearch */
...
//                    'editableOptions' => ['header' => 'Name', 'size' => 'md']
        ...
        [
            ...
            'buttons' => [
                ...
                if ($action === 'view') {
                    $url = Url::to(['domain-of-subject/view', 'id' => $model->id, 'check' => '1']);
                    return $url;
                } else if ($action === 'update') {
                    $url = Url::to(['domain-of-subject/update', 'id' => $model->id, 'check' => '1']);
                    return $url;
                } else if ($action === 'delete') {
                    $url = Url::to(['domain-of-subject/delete', 'id' => $model->id, 'check' => '1']);
                    return $url;
                }
            }
                ],
            ...
            echo GridView::widget([
                'dataProvider' => $dataProviderOfDomainOfSubject,
                'filterModel' => $searchDomainOfSubject,
                'columns' => $gridColumns,
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['domain-of-subject/create', 'check' => 1], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Domain of Subject
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#domain-pjax").on('pjax:complete', function () {
