...
//                    'editableOptions' => ['header' => 'Name', 'size' => 'md']
        ...
        [
            ...
            'buttons' => [
                ...
                if ($action === 'view') {
                    $url = Url::to(['sub-subjects/view', 'id' => $model->id]);
                    return $url;
                } else if ($action === 'update') {
                    $url = Url::to(['sub-subjects/update', 'id' => $model->id]);
                    return $url;
                } else if ($action === 'delete') {
                    $url = Url::to(['sub-subjects/delete', 'id' => $model->id]);
                    return $url;
                }
            }
                ],
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['sub-subjects/create'], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
...
//                    '{toggleData}',
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-book pull-left"></i> Learning Outcomes
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
