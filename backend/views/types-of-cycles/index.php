...
//                    'editableOptions' => ['header' => 'Name', 'size' => 'md']
        ...
        [
            ...
            'buttons' => [
                ...
                if ($action === 'view') {
                    $url = Url::to(['types-of-cycles/view', 'id' => $model->id, 'check' => '2']);
                    return $url;
                } else if ($action === 'update') {
                    $url = Url::to(['types-of-cycles/update', 'id' => $model->id, 'check' => '2']);
                    return $url;
                } else if ($action === 'delete') {
                    $url = Url::to(['types-of-cycles/delete', 'id' => $model->id, 'check' => '2']);
                    return $url;
                }
            }
                ],
            ...
            echo GridView::widget([
                'dataProvider' => $dataProvidersearchTypesOfCycles,
                'filterModel' => $searchTypesOfCycles,
                'columns' => $gridColumns,
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['types-of-cycles/create'], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Types of Cycles
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#types-pjax").on('pjax:complete', function () {
