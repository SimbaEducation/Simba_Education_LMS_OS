...
<div class="user-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'value' => function ($data) {
                $type = '';
                $userType = Category::findOne($data->category_id);
                $type .= '<span class="label label-sm label-primary" style="margin-right:5px;">' . $userType->name . '</span>';
                return $type;
            },
        ],
        [
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['post/create'], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Category
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#post-pjax").on('pjax:complete', function () {
            ...
            function pageSize(status) {
                window.location.href = '<?php echo Url::to(['/post/index']) ?>&per-page=' + status.value;
    }
