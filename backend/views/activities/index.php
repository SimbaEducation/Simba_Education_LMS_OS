...
<div class="user-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'format' => 'raw',
            'value' => function($data) {
                return Html::img(Yii::getAlias('@web') . '/../uploads/question/' . $data['picture'], ['width' => '70px']);
            },
                    'filter' => false
                ],
                'name',
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        if ($action === 'view') {
                            $url = Url::to(['activities/view', 'id' => $model->id]);
                            return $url;
                        } else if ($action === 'update') {
                            $url = Url::to(['activities/update', 'id' => $model->id]);
                            return $url;
                        } else if ($action === 'delete') {
                            $url = Url::to(['activities/delete', 'id' => $model->id]);
                            return $url;
                        }
                    }
                        ],
...
//            </a> ',
                            ...
                            ['content' =>
                                Html::a('<i class="glyphicon glyphicon-plus"></i>', ['activities/create'], ['title' => 'Add Activity', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                        ...
                        'panel' => [
                            ...
                            'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Activities
    ',
                            'footer' => false,
                            'before' => '{pager}',
                        ],
                ...
                <script type="text/javascript">
                    ...
                    function pageSize(status) {
                        window.location.href = '<?php echo Url::to(['/activities/index']) ?>&per-page=' + status.value;
    }
