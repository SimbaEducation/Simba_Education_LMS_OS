...
<div class="form-body">
    ...
    <?= $form->field($model, 'type_of_cycle_id', ['template' => $template, 'labelOptions' => ['class' => $labelClass]])->dropDownList(ArrayHelper::map(TypesOfCycles::find()->all(), 'id', 'name'), ['prompt' => 'Select', 'class' => 'form-control bs-select']) ?>
</div>
