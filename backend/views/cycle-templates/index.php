    ...
    $gridColumns = [
        ...
        [
            ...
            'buttons' => [
                ...
                if ($action === 'view') {
                    $url = Url::to(['cycle-templates/view', 'id' => $model->id]);
                    return $url;
                } else if ($action === 'update') {
                    $url = Url::to(['cycle-templates/update', 'id' => $model->id]);
                    return $url;
                } else if ($action === 'delete') {
                    $url = Url::to(['cycle-templates/delete', 'id' => $model->id]);
                    return $url;
                }
            }
                ],
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['cycle-templates/create'], ['title' => 'Add Activity', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Cycle Templates
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
            ...
            function pageSize(status) {
                window.location.href = '<?php echo Url::to(['/cycle-templates/index']) ?>&per-page=' + status.value;
    }
