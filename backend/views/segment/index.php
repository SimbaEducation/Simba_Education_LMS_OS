    ...
    $gridColumns = [
        ...
        [
            ...
            'buttons' => [
                ...
                if ($action === 'view') {
                    $url = Url::to(['segment/view', 'id' => $model->id]);
                    return $url;
                } else if ($action === 'update') {
                    $url = Url::to(['segment/update', 'id' => $model->id]);
                    return $url;
                } else if ($action === 'delete') {
                    $url = Url::to(['segment/delete', 'id' => $model->id]);
                    return $url;
                }
            }
                ],
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['segment/create'], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Segment Manager
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
             $(document).ready(function () {
                $("#segment-pjax").on('pjax:complete', function () {
            ...
            function pageSize(status) {
                window.location.href = '<?php echo Url::to(['/segment/index']) ?>&per-page=' + status.value;
    }
