...
<div class="user-index">
    ...
    $gridColumns = [
        ...
        [
            ...
            'value' => function ($data) {
                if ($data->type == '1') {
                    return Html::img(Yii::getAlias('@web') . '/../uploads/question/' . $data->outcome_1, ['width' => '70px']);
                } else {
                    return '<span class="label label-sm label-primary" style="margin-right:5px;">' . $data->outcome_1 . '</span>';
                }
            },
                    'filter' => false,
                ],
                ...
                [
                    ...
                    'value' => function ($data) {
                        if ($data->type == '1') {
                            return Html::img(Yii::getAlias('@web') . '/../uploads/question/' . $data->outcome_2, ['width' => '70px']);
                        } else {
                            return '<span class="label label-sm label-primary" style="margin-right:5px;">' . $data->outcome_2 . '</span>';
                        }
                    },
                            'filter' => false,
                        ],
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                if ($data->type == '1') {
                                    return Html::img(Yii::getAlias('@web') . '/../uploads/question/' . $data->outcome_3, ['width' => '70px']);
                                } else {
                                    return '<span class="label label-sm label-primary" style="margin-right:5px;">' . $data->outcome_3 . '</span>';
                                }
                            },
                                    'filter' => false,
                                ],
                                ...
                                [
                                    ...
                                    'value' => function ($data) {
                                        if ($data->type == '1') {
                                            return Html::img(Yii::getAlias('@web') . '/../uploads/question/' . $data->outcome_4, ['width' => '70px']);
                                        } else {
                                            return '<span class="label label-sm label-primary" style="margin-right:5px;">' . $data->outcome_4 . '</span>';
                                        }
                                    },
                                            'filter' => false,
                                        ],
                                        ...
                                        [
                                            ...
                                            'buttons' => [
                                                ...
                                                if ($action === 'view') {
                                                    $url = Url::to(['activity-question/view', 'id' => $model->id]);
                                                    return $url;
                                                } else if ($action === 'update') {
                                                    $url = Url::to(['activity-question/update', 'id' => $model->id]);
                                                    return $url;
                                                } else if ($action === 'delete') {
                                                    $url = Url::to(['activity-question/delete', 'id' => $model->id]);
                                                    return $url;
                                                }
                                            }
                                                ],
...
//            </a> ',
                                                    ...
                                                    ['content' =>
                                                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['activity-question/create'], ['title' => 'Add Activity Question', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                                                ...
                                                'panel' => [
                                                    ...
                                                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Activity Questions
    ',
                                                    'footer' => false,
                                                    'before' => '{pager}',
                                                ],
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function () {
                                                $("#question-pjax").on('pjax:complete', function () {
                                            ...
                                            function pageSize(status) {
                                                window.location.href = '<?php echo Url::to(['/activity-question/index']) ?>&per-page=' + status.value;
    }
