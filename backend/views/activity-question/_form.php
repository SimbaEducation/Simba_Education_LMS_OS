...
<div class="portlet-body form">
    <div class="form-body">
        <div class="row">
            ...
            <?= $form->field($model, 'type', ['template' => $template, 'labelOptions' => ['class' => $labelClass]])->dropdownList(['' => 'Select', '1' => 'Image', '2' => 'Text'], ['class' => 'form-control', 'onchange' => 'display(this.value);']) /* , ['prompt' => 'Select Data'] */ ?>
