        ...
        [
            ...
            'buttons' => [
                'view' => function ($url, $model) {
                    ...
                    if ($model->id != 1 && $model->id != yii::$app->user->id) {
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['user/create'], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Users
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#user-pjax").on('pjax:complete', function () {
            ...
            function pageSize(status) {
                window.location.href = '<?php echo Url::to(['/user/index']) ?>&per-page=' + status.value;
    }
