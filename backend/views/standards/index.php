...
//                    'editableOptions' => ['header' => 'Name', 'size' => 'md']
        ...
        [
            ...
            'buttons' => [
                ...
                if ($action === 'view') {
                    $url = Url::to(['standards/view', 'id' => $model->id, 'check' => '3']);
                    return $url;
                } else if ($action === 'update') {
                    $url = Url::to(['standards/update', 'id' => $model->id, 'check' => '3']);
                    return $url;
                } else if ($action === 'delete') {
                    $url = Url::to(['standards/delete', 'id' => $model->id, 'check' => '3']);
                    return $url;
                }
            }
                ],
            ...
            echo GridView::widget([
                'dataProvider' => $dataProvidersearchStandards,
                'filterModel' => $searchStandards,
                'columns' => $gridColumns,
...
//            </a> ',
                    ...
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['standards/create'], ['title' => 'Add Activity Category', 'data-pjax' => '0', 'style' => 'padding:11px 14px 8px 14px !important;color:#fff !important', 'class' => 'btn btn-success']) . ' ' .
                ...
                'panel' => [
                    ...
                    'heading' => '<i style="margin-right:5px;" class="glyphicon glyphicon-tag pull-left"></i> Standards
    ',
                    'footer' => false,
                    'before' => '{pager}',
                ],
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#standards-pjax").on('pjax:complete', function () {
