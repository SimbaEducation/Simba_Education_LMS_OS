...
namespace metronic\materialassets\bootstrapDatePicker;
...
{
    public $sourcePath = '@metronic/materialassets/bootstrapDatePicker/dist';
    public $depends = [
        'metronic\materialassets\bootstrapDatePicker\BootstrapDatePickerAsset'
    ];
    public $jsOptions = [
