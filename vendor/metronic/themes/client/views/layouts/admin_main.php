...
use metronic\themes\client\assets\AppAsset as AdminAppAsset;
use metronic\themes\client\assets\ThemeAsset as AdminThemeAsset;
...
<?php
	...
	// Body Begins
	echo Html::beginTag('body', ['class' => 'page-md page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed-hide-logo page-header-fixed']);
		$this->beginBody();
