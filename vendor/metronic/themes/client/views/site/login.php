...
<div class="logo">
    <a href="<?= Yii::getAlias('@web')?>">
            <?php echo Html::img((!empty(Yii::$app->settings->getValue('general','headerLogo')) ? 'http://104.236.41.126/RocoCPM/client/assets_c/images/logo-light.png': '@web/assets_b/images/logo-light.png'), ['alt'=>'logo', 'class'=>'logo-default','width'=>'100px']) ?>
	</a>
	...
	<form class="login-form" action="<?= Url::to(['site/login']) ?>" method="post">
		...
		<h3 class="form-title">Sign In</h3>
			...
			<span><?= Yii::$app->session->getFlash('error'); ?></span>
                ...
                <?php endif;?>
		<div class="alert alert-danger display-hide" style="<?= $model->hasErrors() ? 'display:block;' : 'display:none;' ?>">
			<button class="close" data-close="alert"></button>
