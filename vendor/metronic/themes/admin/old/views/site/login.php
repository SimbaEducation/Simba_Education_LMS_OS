...
<div class="logo">
	<a href="index.html">
		<img src="../../assets/admin/layout4/img/logo-big.png" alt=""/>
                <?php echo Html::img((!empty(Yii::$app->settings->getValue('general','headerLogo')) ? '@web/../uploads/settings/'.Yii::$app->settings->getValue('general','headerLogo'): '@web/assets_b/images/logo-light.png'), ['alt'=>'logo', 'class'=>'logo-default','width'=>'100px']) ?>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
