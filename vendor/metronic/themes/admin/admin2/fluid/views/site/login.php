...
<div class="logo">
    <a href="<?= Yii::getAlias('@web')?>">
            <?php echo Html::img((!empty(Yii::$app->settings->getValue('general','headerLogo')) ? '@web/assets_c/images/logo-new.png': '@web/assets_b/images/logo-light.png'), ['alt'=>'logo', 'class'=>'logo-default','width'=>'100px']) ?>
	</a>
