...
use metronic\themes\admin\admin4\fluid\assets\LoginAppAsset;
use metronic\themes\admin\admin4\fluid\assets\LoginThemeAsset;
...
<?php
	...
	// Body Begins
	echo Html::beginTag('body', ['class' => 'login']);
		$this->beginBody();
			echo $content;
		$this->endBody();
