...
class ActiveField extends Component
{
     ...
     */
    public $options = ['class' => 'form-group form-md-line-input'];
    /**
...
//        $class[] = '<div class="form-control-focus"> </div>';
    ...
    public function textInput($options = [])
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        $this->parts['{input}'] = Html::activeTextInput($this->model, $this->attribute, $options)."<div class='form-control-focus'></div>";
