...
class SideNav extends \yii\widgets\Menu
{
     ...
     */
    public $indMenuOpen = '<i class=""></i>'; //indicator glyphicon glyphicon-chevron-down

    /**
     * @var string indicator for a closed sub-menu
     */
    public $indMenuClose = '<i class=""></i>'; //indicator glyphicon glyphicon-chevron-right
    ...
    public function run()
    {
        ...
        Html::addCssClass($this->containerOptions, "bottom");
        Html::addCssStyle($this->containerOptions, "margin-bottom:0px;");
    ...
    protected function renderItem($item)
    {
        ...
        if (empty($item['top'])) {
            if (empty($item['items'])) {
                ...
                $openOptions = ($item['active']) ? ['class' => 'opened arrow open'] : ['class' => 'opened arrow open', 'style' => 'display:none'];
                $closeOptions = ($item['active']) ? ['class' => 'closed arrow', 'style' => 'display:none'] : ['class' => 'closed arrow'];
